                                ...
                                <div className="content-body">
                                    <div className="row">
                                        <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8">
                                            ...
                                            <form method="POST" action="http://localhost:3000/admin/create">
                                                <div className="form-row">
                                                    ...
                                                    <div className="form-group col-md-12">
                                                        <label htmlFor="inputname4">Age</label>
                                                        <input type="text" className="form-control"  name="age" id="age" placeholder="" />
                                                    </div>
